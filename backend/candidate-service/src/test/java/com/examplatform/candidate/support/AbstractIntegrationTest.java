...
package com.examplatform.candidate.support;
...
/**
 * Production-grade base class for candidate-service MockMvc integration tests using Testcontainers.
 */
            ...
            try {
                List<String> tableNames = jdbcTemplate.queryForList(
                        "SELECT table_name FROM information_schema.tables " +
                                "WHERE table_schema = 'candidate_service' " +
                ...
                for (String table : tableNames) {
                    jdbcTemplate.execute("TRUNCATE TABLE candidate_service." + table + " RESTART IDENTITY CASCADE");
                }
            } catch (Exception ex) {
