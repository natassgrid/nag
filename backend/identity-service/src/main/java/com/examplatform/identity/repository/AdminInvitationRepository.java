...
public interface AdminInvitationRepository extends JpaRepository<AdminInvitation, UUID> {
    ...
    Optional<AdminInvitation> findByEmailHashAndTenantIdAndStatus(String emailHash, String tenantId, String status);

    List<AdminInvitation> findByTenantIdOrderByCreatedAtDesc(String tenantId);
}
