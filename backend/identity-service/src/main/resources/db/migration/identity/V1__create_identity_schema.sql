...
CREATE INDEX IF NOT EXISTS idx_user_account_email_hash ON identity_service.user_account(email_hash);
CREATE INDEX IF NOT EXISTS idx_user_account_mobile_hash ON identity_service.user_account(mobile_hash);
CREATE INDEX IF NOT EXISTS idx_user_account_keycloak_user_id ON identity_service.user_account(keycloak_user_id);
CREATE INDEX IF NOT EXISTS idx_user_account_specialization ON identity_service.user_account(specialization);
...
CREATE INDEX IF NOT EXISTS idx_otp_verification_tenant_id ON identity_service.otp_verification(tenant_id);
CREATE INDEX IF NOT EXISTS idx_otp_verification_mobile_hash ON identity_service.otp_verification(mobile_hash);
CREATE INDEX IF NOT EXISTS idx_otp_verification_user_id ON identity_service.otp_verification(user_id);
...
-- ============================================================
CREATE TABLE IF NOT EXISTS identity_service.admin_invitation (
    id                  UUID PRIMARY KEY,
    tenant_id           VARCHAR(255) NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_admin_invitation_tenant ON identity_service.admin_invitation(tenant_id);
CREATE INDEX IF NOT EXISTS idx_admin_invitation_email_hash ON identity_service.admin_invitation(email_hash);
CREATE INDEX IF NOT EXISTS idx_admin_invitation_token_hash ON identity_service.admin_invitation(token_hash);
CREATE INDEX IF NOT EXISTS idx_admin_invitation_status ON identity_service.admin_invitation(status);
...
-- ============================================================
CREATE TABLE IF NOT EXISTS identity_service.role_definition (
    id          UUID PRIMARY KEY,
    tenant_id   VARCHAR(255) NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_role_definition_code_tenant
...
CREATE INDEX IF NOT EXISTS idx_role_definition_active
...
-- ============================================================
CREATE TABLE IF NOT EXISTS identity_service.permission (
    id          UUID PRIMARY KEY,
    tenant_id   VARCHAR(255) NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_permission_code_tenant
    ON identity_service.permission(code, tenant_id);
CREATE INDEX IF NOT EXISTS idx_permission_tenant_id
...
VALUES
    ('018f4e2b-0000-7000-8000-000000000001', 'default', 'Super Admin', 'SUPER_ADMIN', 'Full system access with all permissions', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000002', 'default', 'Security Admin', 'SECURITY_ADMIN', 'Manages security policies and user access', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000003', 'default', 'Question Author', 'QUESTION_AUTHOR', 'Creates and edits examination questions', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000004', 'default', 'Reviewer', 'REVIEWER', 'Reviews and validates questions', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000005', 'default', 'Subject Matter Expert', 'SUBJECT_MATTER_EXPERT', 'Subject matter expert for authoring, reviewing, and validating subject questions', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000006', 'default', 'Approver', 'APPROVER', 'Approves questions and papers for publication', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000007', 'default', 'Exam Controller', 'EXAM_CONTROLLER', 'Manages examination scheduling and delivery', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000008', 'default', 'Translator', 'TRANSLATOR', 'Translates questions to regional languages', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-000000000009', 'default', 'Evaluator', 'EVALUATOR', 'Evaluates subjective responses', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-00000000000a', 'default', 'Auditor', 'AUDITOR', 'Views audit trails and compliance reports', TRUE, TRUE),
    ('018f4e2b-0000-7000-8000-00000000000b', 'default', 'Candidate', 'CANDIDATE', 'Takes examinations and views results', TRUE, TRUE)
