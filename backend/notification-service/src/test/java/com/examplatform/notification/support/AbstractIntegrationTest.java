...
package com.examplatform.notification.support;
...
/**
 * Production-grade base class for notification-service MockMvc integration tests using Testcontainers.
 */
...
public abstract class AbstractIntegrationTest {
    ...
    static void configureContainerProperties(DynamicPropertyRegistry registry) {
        if (testcontainersAvailable && POSTGRES_CONTAINER != null && POSTGRES_CONTAINER.isRunning()) {
            ...
            registry.add("spring.flyway.schemas", () -> "notification_service");
            registry.add("spring.flyway.default-schema", () -> "notification_service");
        ...
        if (testcontainersAvailable && jdbcTemplate != null) {
            try {
                ...
                for (String table : tableNames) {
                    jdbcTemplate.execute("TRUNCATE TABLE notification_service." + table + " RESTART IDENTITY CASCADE");
                }
            } catch (Exception ex) {
