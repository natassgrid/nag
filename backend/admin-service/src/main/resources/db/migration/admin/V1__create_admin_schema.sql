...
CREATE TABLE IF NOT EXISTS admin_service.system_config (
    id              UUID PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_system_config_tenant_id ON admin_service.system_config(tenant_id);
CREATE INDEX IF NOT EXISTS idx_system_config_param_name ON admin_service.system_config(param_name);
