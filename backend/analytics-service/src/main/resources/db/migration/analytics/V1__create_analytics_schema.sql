...
CREATE TABLE IF NOT EXISTS analytics_service.exam_analytics (
    id                              UUID PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_exam_analytics_exam_id ON analytics_service.exam_analytics(exam_id);
