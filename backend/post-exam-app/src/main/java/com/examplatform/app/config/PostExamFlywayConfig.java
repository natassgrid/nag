...
/**
 * Executes Flyway database migrations for evaluation_service, result_service,
 * and analytics_service sequentially within post-exam-app.
 */
@Slf4j
@Configuration
@ConditionalOnProperty(name = "platform.flyway.auto-migrate", havingValue = "true", matchIfMissing = true)
@RequiredArgsConstructor
public class PostExamFlywayConfig {
