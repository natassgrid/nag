...
@Component({
  selector: 'nag-settings-evaluation-tab',
  standalone: true,
  imports: [CommonModule, FormsModule, MatIconModule, MatSlideToggleModule],
  templateUrl: './settings-evaluation-tab.component.html',
  styleUrl: './settings-evaluation-tab.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SettingsEvaluationTabComponent {
